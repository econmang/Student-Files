...
class ChipBank:
    ...
    def __init__(self,amount):
        ...
        try:
            ...
            print("ChipBank Balance amount must be 0 or greater.")
    ...
    def withdraw(self,amount):
        ...
        try:
            if self._balance - amount > 0:
                ...
                if self._should_log:
                    try:
                        fh = open("banklog.txt", "a+")
                        fh.write(str(self.get_balance()) + "\t-" + str(amount) + "\n")
                        fh.close()
                    except IOError:
            ...
            fh = open("banklog.txt","a+")
            fh.write(str(self.get_balance()) + "\t0" +"\tinvalid withdraw amount\n")
            fh.close()
