...
//Check if username exists USING PREPARED STATEMENTS
					$sql = "SELECT * FROM login2 WHERE user_uid=?";
...
//Hashing the password
							$hashedPdw = password_hash($pdw, PASSWORD_DEFAULT);
//Insert the user into the database
							$sql = "INSERT INTO login2(user_first, user_last, user_email, user_uid, user_pdw)
							VALUES (?, ?, ?, ?, ?);";
...
//Bind parameters to the placeholder
								mysqli_stmt_bind_param($stmt2, "sssss", $first, $last, $email, $uid, $hashedPdw);
